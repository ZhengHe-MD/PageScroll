   ...
   */
		this.init = function (_this) {
			return function (bindTo, scrollIn) {
				...
				loop = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame || _this.scrollElement.onscroll; // old school browser support
